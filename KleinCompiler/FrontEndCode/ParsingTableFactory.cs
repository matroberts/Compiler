namespace KleinCompiler.FrontEndCode
{
    public class ParsingTableFactory
    {
        ...
        private static Rule R29 => new Rule("R29", Symbol.If, Symbol.PushPosition, Symbol.Expr, Symbol.Then, Symbol.Expr, Symbol.Else, Symbol.Expr, Symbol.MakeIfThenElse);
        ...
        private static Rule R46 => new Rule("R46", Symbol.PrintKeyword, Symbol.PushPosition, Symbol.OpenBracket, Symbol.Expr, Symbol.CloseBracket, Symbol.MakePrint);
